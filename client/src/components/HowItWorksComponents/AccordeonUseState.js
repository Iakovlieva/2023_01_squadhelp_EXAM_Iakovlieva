...
/* Сначала сделала через useState, а потом нашла как делать CSS с маленькой добавкой JS на закрытие
эту компоненту совсем выкидывать не стала, жалко труда)
Но здесь не поддерживается распознавание структуры ответов, предполагается что ответ- строка
*/