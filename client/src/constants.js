        ...
        answer: [
          `While it is unusually rare that you will not like any names provided, we have a few options in case this problem occurs:`,
           [ 
              ...
              [
                `If you choose the Gold package or Platinum package and keep the contest as "Not Guaranteed", you can request a partial refund if you choose not to move forward with any name from you project. (Please note that the refund is for the contest award). Here is a link to our `
                ,
                {
                  link: `https://helpdesk.squadhelp.com/en/articles/115621-refund-policy`,
                  text: `Refund Policy`
                }
              ]
            ]
      ...
      },
      {
        ...
        answer: [
          ...
          [
            ...
            [{
              link: `/tagline-slogan-ideas`,
              text: `Tagline Examples`
            }],
            [{
              link: `/logo-design-examples`,
              text: `Logo Examples`
            }] 
          ]
        ] 
        ...
        answer: [`We offer two levels of Managed Contests. Standard ($1499) and Enterprise ($2999). The Enterprise managed contest includes:`,
          [ 
            ...
            [`Here is a link to our `,
                {
                  link: `https://www.squadhelp.com/views/contests/create/managed_contests.php`,
                  text: `Pricing page`
                },
